...
color_code_host_cate_txt    = '/Users/songweizhi/Desktop/Sponge_r226/00_metadata/color_code_Host_Category.txt'
...
# 2284
gnm_id_txt                  = '/Users/songweizhi/Desktop/Sponge_r226/00_metadata/gnm_id_2284.txt'
itol_file_dir               = '/Users/songweizhi/Desktop/Sponge_r226/00_metadata/iTOL_2284'

'''
TreeSAK iTOL -ColorStrip -strip_width 300 -hide_legend -show_label -lg /Users/songweizhi/Desktop/Sponge_r226/00_metadata/AOA_metadata_20251225_DBSCC.txt -gc /Users/songweizhi/Desktop/Sponge_r226/00_metadata/color_code_DBSCCs.txt -lt Genus -o /Users/songweizhi/Desktop/Sponge_r226/00_metadata/AOA_metadata_20251225_DBSCC_iTOL.txt
'''
...
gnm_lifestyle_txt           = '%s/tmp/gnm_lifestyle.txt'            % itol_file_dir
host_category_txt           = '%s/tmp/host_category.txt'            % itol_file_dir
...
gnm_lifestyle_txt_itol      = '%s/iTOL_gnm_lifestyle.txt'           % itol_file_dir
host_category_txt_itol      = '%s/iTOL_host_category.txt'           % itol_file_dir
...
gnm_lifestyle_txt_handle = open(gnm_lifestyle_txt, 'w')
host_category_txt_handle = open(host_category_txt, 'w')
...
gnm_lifestyle_txt_handle.write('Genome\tLifestyle\n')
...
for each_gnm in open(meta_data_txt):
    ...
    if each_gnm.startswith('Genome\t'):
        ...
        if gnm_id in gnm_id_set:
            ...
            host_cate               = each_gnm_split[col_index['Host_Category_2']]
            ...
            if host_species == 'nonsponge':
                ...
                gnm_lifestyle = '1'
            gnm_lifestyle_txt_handle.write('%s\t%s\n' % (gnm_id, gnm_lifestyle))
            host_category_txt_handle.write('%s\t%s\n' % (gnm_id, host_cate))
...
gnm_lifestyle_txt_handle.close()
gnm_size_txt_handle.close()
host_category_txt_handle.close()
...
for interested_gnm in gnm_to_genus_dict:
    ...
    str_to_write = '%s\t%s___%s' % (interested_gnm, current_genus, interested_gnm_to_write)
...
biosak_cmd_host_cate            = 'TreeSAK iTOL -ColorStrip -strip_width 300 -show_label -lg %s -gc %s -lt "Host Category" -o %s'  % (host_category_txt,  color_code_host_cate_txt, host_category_txt_itol)
...
biosak_cmd_lifestyle            = 'TreeSAK iTOL -Binary -lm %s -lt Lifestyle -cc "#c09568" -o %s'                                               % (gnm_lifestyle_txt, gnm_lifestyle_txt_itol)
...
os.system(biosak_cmd_lifestyle)
os.system(biosak_cmd_host_cate)
